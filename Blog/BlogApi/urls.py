...
urlpatterns = [
    ...
    path('posts/<int:pk>/comment-postdetail/', CommentPostDetail.as_view(), name='comment_postdetail'),
    path('comment/<int:comment_id>/reply-list/', CommentReplyList.as_view(), name='list_replycomment'),
